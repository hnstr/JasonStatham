...
public class DefaultDriverAlgorithm extends AbstractAlgorithm {
    ...
    private ArrayList<double[]> drivers = new ArrayList<>();
    ...
    public double getLaptime(DefaultDriver driver) {
        ...
        try {
            ProcessBuilder builder = new ProcessBuilder(
                    "cmd.exe", "/c", "cd \"C:/Informatica/JasonStatham/torcs-win/Torcs\" && start wtorcs -r C:\\Informatica\\JasonStatham\\torcs-win\\Torcs\\config\\raceman\\quickrace.xml");
